						...
						<div className="column">
							<div className="about-content--item">
								...
								<p className="about-content--item-desc">
									...
									poziomie szkoły podstawowej, tak aby wyrównać braki edukacyjne, ale również wspieram edukacje uczniów
									zdolnych. Od podstaw uczę czytania oraz pisania, a także pomagam rozwinąć już posiadane umiejętności.
									Przeprowadzam zajęcia mające na celu poszerzanie umiejętności komunikacyjnych i ułatwienie
								...
								<p className="about-content--item-desc">
									W razie jakichkolwiek pytań lub sugestii zapraszam do kontaktu.
								</p>
							</div>
						</div>
						<div className="column">
